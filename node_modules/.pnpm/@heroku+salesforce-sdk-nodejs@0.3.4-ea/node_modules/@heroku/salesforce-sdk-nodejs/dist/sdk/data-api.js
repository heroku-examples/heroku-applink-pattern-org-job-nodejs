...
const connection_js_1 = require("jsforce/lib/connection.js");
...
class DataApiImpl {
    ...
    async connect() {
        if (!this.conn) {
            this.conn = new connection_js_1.Connection({
    ...
    newUnitOfWork() {
        return new unit_of_work_js_1.UnitOfWorkImpl(this.apiVersion);
    }
...
async function buildQueriedRecord(conn, data) {
    ...
    const queriedRecord = {
        type,
        fields: (0, maps_js_1.createCaseInsensitiveMap)(fields),
        subQueryResults: (0, maps_js_1.createCaseInsensitiveMap)(subQueryResults),
    };
    if (Object.keys(binaryFields).length) {
        return {
            ...queriedRecord,
            binaryFields: (0, maps_js_1.createCaseInsensitiveMap)(binaryFields),
        };
    }
